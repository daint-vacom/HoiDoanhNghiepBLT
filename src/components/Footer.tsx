    ...
    <footer className="bg-red-950 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-red-100/70 text-sm leading-relaxed">
              Hội Doanh nghiệp Bình Lợi Trung là tổ chức kết nối các doanh
              nghiệp, thúc đẩy giao thương và hỗ trợ phát triển bền vững cho
              cộng đồng doanh nhân.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-red-900 flex items-center justify-center hover:bg-red-700 transition-colors"
              >
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-b border-red-800 pb-2 inline-block">
              Liên hệ
            </h3>
            <ul className="space-y-4 text-sm text-red-100/70">
              <li className="flex items-start">
                ...
                <span>
                  Số 123, Đường Bình Lợi, Phường 13, Quận Bình Thạnh, TP. Hồ Chí
                  Minh
                </span>
              </li>
          ...
          <div>
            ...
            <p className="text-sm text-red-100/70 mb-4">
              Đăng ký để nhận những thông tin mới nhất từ Hội.
            </p>
        ...
        <div className="pt-8 border-t border-red-900 text-center text-xs text-red-100/40">
          <p>
            Copyright © 2026 BLTBA - Binh Loi Trung Business Association. All
            Rights Reserved.
          </p>
        </div>
      </div>
